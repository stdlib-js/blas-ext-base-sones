...
var sones = tryRequire( resolve( __dirname, './../lib/sones.native.js' ) );
var opts = {
	'skip': ( sones instanceof Error )
};
...
tape( 'the function has an arity of 3', opts, function test( t ) {
	t.strictEqual( sones.length, 3, 'has expected arity' );
	t.end();
});
